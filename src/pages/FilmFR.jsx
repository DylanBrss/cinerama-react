...
const API_URL =
  "https://api.themoviedb.org/3/discover/movie?api_key=8d2265a50d4907bf6dd28e4ad308b47e&language=fr&include_adult=false&with_original_language=fr";
...
const FilmFR = () => {
  ...
  return (
    <div>
      ...
      <NavBar />
      <h2 className="text-center mt-5 text-white">Film Français</h2>
